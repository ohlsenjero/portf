...
$('.divo').click(function() {   /// algo raro pasa aqui
   ...
   $('.divo:hover').css('cursor','default');
    ...
    if(idol[0]=='divo1'){    
      ...
      initText('Dinamic JS: This site is meant to work as an api, with everything in it being generated automatically according to a JS object, which is created from a siple text file (or JSON file) ', divo2text, "0");
...
function() {
  ...
  divo1.innerHTML = "<div class=\"innertext-wrapper\"><div id=\"divo1text\"></div></div><div class=\"pattern-bg\"><div class=\"divosite\"><a href=\"https://rawgit.com/ohlsenjero/portf/master/DMlive-site\" target=\"_blank\">VIEW SITE</a></div></div>";
  divo2.innerHTML = "<div class=\"innertext-wrapper\"><div id=\"divo2text\"></div></div><div class=\"pattern-bg\"><div class=\"divosite\"><a href=\"hhttps://rawgit.com/ohlsenjero/portf/master/js-api\" target=\"_blank\">VIEW SITE</a></div></div>";
  ...
  divo1.innerHTML = "<div class=\"innertext-wrapper\"><div id=\"divo1text\"></div></div><div class=\"pattern-bg\"><div class=\"divosite\"><a href=\"https://rawgit.com/ohlsenjero/portf/master/DMlive-site\" target=\"_blank\">VIEW SITE</a></div></div>";
  divo2.innerHTML = "<div class=\"innertext-wrapper\"><div id=\"divo2text\"></div></div><div class=\"pattern-bg\"><div class=\"divosite\"><a href=\"https://rawgit.com/ohlsenjero/portf/master/js-api\" target=\"_blank\">VIEW SITE</a></div></div>";
  divo3.innerHTML = "<div class=\"innertext-wrapper\"><div id=\"divo3text\"></div></div><div class=\"pattern-bg\"><div class=\"divosite\"><a href=\"https://rawgit.com/ohlsenjero/portf/master/wow/index.html\" target=\"_blank\">VIEW SITE</a></div></div>";
