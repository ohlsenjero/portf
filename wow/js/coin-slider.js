...
(function ($) {
		...
		var setNavigation = function (el) {
			...
			$.each($('.cs-button-' + el.id), function(i,item){
				$(item).click( function(e){
					...
					e.preventDefault();
					transition(el,i);
					transitionCall(el);                                                                                  //  IMAGE thumbnails
				});
			});
	...
	$.fn.coinslider.defaults = {
		width: 356, // width of slider panel                                <<<<<<<< Your Image's dimensions  HERE
		height: 472, // height of slider panel
		spw: 7, // squares per width
		sph: 5, // squares per height
		delay: 10000000000, // delay between images in ms                       <<<<<<<< time between photos   (1000000000 =?== infinite)
